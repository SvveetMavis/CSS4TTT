...
hook.Add("TTTPlayerSpeedModifier", "XMSpeed" , function(ply, _, _, noLag )
    local wep=ply:GetActiveWeapon()
    if wep and IsValid(wep) and wep:GetClass()=="weapon_zm_shotgun" then
      if TTT2 then
        noLag[1] = noLag[1] * 0.9
      else
        return 0.9
